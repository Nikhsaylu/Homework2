public class Main {
    ...
    public static void task7() {
        ...
        var differenceWeignt = secondBoxerWeight - firstBoxerWeight;
        System.out.println("Разница в весе " +differenceWeignt + " кг");
        var procent = secondBoxerWeight % firstBoxerWeight;
        System.out.println("Остаток от деления " + procent + " процентов");
    }
    public static void task8() {
        System.out.println("Задача 8");
        var totalHours = 640;
        var worker = 8;
        var totalWorker = totalHours / worker;
